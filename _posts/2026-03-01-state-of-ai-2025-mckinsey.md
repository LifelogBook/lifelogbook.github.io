...
layout: single
classes: wide
title: "AI 현황 2025 — 에이전트·혁신·변환 - McKinsey"
categories: Report
tags: [AI, mckinsey, agents, gen-ai, enterprise, workforce, risk, english-study, agentic-ai]
toc: true
toc_sticky: true
toc_label: "목차"
...
> **원문:** *The State of AI in 2025: Agents, Innovation, and Transformation*
> **발행:** QuantumBlack, AI by McKinsey / November 2025
> **저자:** Alex Singla, Alexander Sukharevsky, Lareina Yee, Michael Chui, Bryce Hall, Tara Balakrishnan
> **서베이:** 1,993명 · 105개국 · 2025년 6월 25일~7월 29일 · 총 30페이지
...
거의 모든 설문 응답자가 자신의 조직이 AI를 사용하고 있다고 답했으며, 많은 이들이 AI 에이전트 도입을 시작했다. 그러나 대부분은 AI를 기업 전체로 스케일링하고 기업 수준의 가치를 창출하는 단계에 아직 이르지 못하고 있다.

**Key Finding 1 — 대부분의 조직은 여전히 실험 또는 파일럿 단계에 있다**
응답자의 거의 3분의 2가 자신의 조직이 아직 기업 전체에 AI를 스케일링하지 않았다고 답했다.

**Key Finding 2 — AI 에이전트에 대한 높은 관심**
설문 응답자의 62%가 자신의 조직이 AI 에이전트를 적어도 실험 중이라고 답했다.

**Key Finding 3 — AI 영향에 대한 긍정적 선행 지표**
응답자들은 개별 유스케이스 수준의 비용 및 매출 혜택을 보고하며, 64%가 AI가 혁신을 가능하게 하고 있다고 답했다. 그러나 기업 전체 EBIT 영향을 보고하는 응답자는 39%에 불과하다.

**Key Finding 4 — 고성과 기업은 AI를 성장·혁신·비용 절감에 모두 활용한다**
응답자의 80%가 효율성을 AI 이니셔티브의 목표로 설정하고 있지만, AI에서 가장 많은 가치를 창출하는 기업들은 성장이나 혁신도 추가 목표로 설정하는 경향이 있다.

**Key Finding 5 — 워크플로우 재설계가 핵심 성공 요인**
AI 고성과 기업의 절반이 AI를 통해 비즈니스를 변혁하려 하며, 대부분이 워크플로우를 재설계하고 있다.

**Key Finding 6 — 고용 영향에 대한 상이한 시각**
응답자들은 향후 1년간 AI가 조직의 전체 인력 규모에 미치는 영향에 대해 서로 다른 전망을 갖고 있다: 32%는 감소를 예상하고, 43%는 변화 없음, 13%는 증가를 예상한다.

---

### 1. AI 사용 확대, 그러나 여전히 파일럿 단계

#### AI 도입률 지속 상승

생성형 AI 도구의 등장이 새로운 인공지능 시대를 촉발한 지 3년이 지났다. 설문 응답자의 10명 중 거의 9명이 자신의 조직에서 정기적으로 AI를 사용하고 있다고 답했다. 그러나 발전 속도는 고르지 않다. AI 도구는 이제 보편화됐지만, 대부분의 조직은 아직 이를 워크플로우와 프로세스에 충분히 깊이 내재화해 실질적인 기업 수준의 혜택을 실현하지 못하고 있다.
...
| 2022 | 56 |
| 2023 | 72 → 생성형 AI: 33 |
| 2024 | 78 → 생성형 AI: 65→71 |
| 2025 | **88** |

2025년 AI 사용 단계 분포:
- **완전 스케일(Fully scaled):** 7% — AI가 조직 전체에 완전 배포·통합됨
- **스케일링(Scaling):** 31% — 조직 전반에 AI 배포·채택 확대 중
- **파일럿(Piloting):** 30% — 첫 번째 유스케이스 구현 중
- **실험(Experimenting):** 32% — AI 초기 테스트 단계

#### AI 에이전트 실험 증가

조직들은 AI 에이전트 기회 탐색을 시작하고 있다. AI 에이전트는 foundation model을 기반으로 실제 세계에서 행동하고, 워크플로우의 여러 단계를 자율적으로 계획·실행할 수 있는 시스템이다.

응답자의 23%가 자신의 조직이 기업 내 어딘가에서 에이전트형 AI 시스템을 스케일링하고 있다고 보고했으며, 추가로 39%는 AI 에이전트 실험을 시작했다. 단, 에이전트 사용은 아직 광범위하지 않다: 스케일링 중이라는 응답자 대부분은 1~2개 기능에서만 하고 있으며, 개별 비즈니스 기능에서 AI 에이전트를 스케일링하고 있다는 응답자는 10% 이하에 그친다(Exhibit 2).

**기능별 AI 에이전트 사용 현황 (스케일링 + 완전 스케일링 기준, %, Exhibit 2 · 3 요약)**

<table style="border-collapse:collapse; width:100%; font-size:13.5px;">
<thead>
<tr style="background:#1e1b4b; color:white;">
<th style="padding:10px 14px; text-align:left;">비즈니스 기능</th>
<th style="padding:10px 14px; text-align:center;">에이전트 스케일링(%)</th>
<th style="padding:10px 14px; text-align:center;">전체 에이전트 실험·파일럿·스케일(%)</th>
</tr>
</thead>
<tbody>
<tr style="background:#f8f9ff;; color:#1e293b;"><td style="padding:8px 14px; border-bottom:1px solid #e0e4f0;">IT</td><td style="padding:8px 14px; text-align:center; font-weight:600; color:#3730a3;">9</td><td style="padding:8px 14px; text-align:center;">27</td></tr>
<tr><td style="padding:8px 14px; border-bottom:1px solid #e0e4f0;">지식 관리</td><td style="padding:8px 14px; text-align:center; font-weight:600; color:#3730a3;">8</td><td style="padding:8px 14px; text-align:center;">25</td></tr>
<tr style="background:#f8f9ff;; color:#1e293b;"><td style="padding:8px 14px; border-bottom:1px solid #e0e4f0;">마케팅 및 영업</td><td style="padding:8px 14px; text-align:center; font-weight:600; color:#3730a3;">7</td><td style="padding:8px 14px; text-align:center;">22</td></tr>
<tr><td style="padding:8px 14px; border-bottom:1px solid #e0e4f0;">서비스 운영</td><td style="padding:8px 14px; text-align:center; font-weight:600; color:#3730a3;">7</td><td style="padding:8px 14px; text-align:center;">21</td></tr>
<tr style="background:#f8f9ff;; color:#1e293b;"><td style="padding:8px 14px; border-bottom:1px solid #e0e4f0;">제품/서비스 개발</td><td style="padding:8px 14px; text-align:center; font-weight:600; color:#3730a3;">7</td><td style="padding:8px 14px; text-align:center;">20</td></tr>
<tr><td style="padding:8px 14px; border-bottom:1px solid #e0e4f0;">소프트웨어 엔지니어링</td><td style="padding:8px 14px; text-align:center; font-weight:600; color:#3730a3;">7</td><td style="padding:8px 14px; text-align:center;">16</td></tr>
<tr style="background:#f8f9ff;; color:#1e293b;"><td style="padding:8px 14px; border-bottom:1px solid #e0e4f0;">리스크·법무·컴플라이언스</td><td style="padding:8px 14px; text-align:center; color:#6b7280;">5</td><td style="padding:8px 14px; text-align:center;">13</td></tr>
<tr><td style="padding:8px 14px; border-bottom:1px solid #e0e4f0;">인사(HR)</td><td style="padding:8px 14px; text-align:center; color:#6b7280;">4</td><td style="padding:8px 14px; text-align:center;">11</td></tr>
<tr style="background:#f8f9ff;; color:#1e293b;"><td style="padding:8px 14px; border-bottom:1px solid #e0e4f0;">전략·기업 재무</td><td style="padding:8px 14px; text-align:center; color:#6b7280;">4</td><td style="padding:8px 14px; text-align:center;">9</td></tr>
<tr><td style="padding:8px 14px; border-bottom:1px solid #e0e4f0;">공급망/재고 관리</td><td style="padding:8px 14px; text-align:center; color:#6b7280;">2</td><td style="padding:8px 14px; text-align:center;">8</td></tr>
<tr style="background:#f8f9ff;; color:#1e293b;"><td style="padding:8px 14px;">제조</td><td style="padding:8px 14px; text-align:center; color:#6b7280;">2</td><td style="padding:8px 14px; text-align:center;">5</td></tr>
</tbody>
</table>

*출처: McKinsey Global Survey on the state of AI, 1,993 participants, June 25–July 29, 2025*

산업별로는 기술, 미디어·통신, 의료 부문에서 AI 에이전트 사용이 가장 많이 보고되고 있다.

> **Michael Chui, Senior Fellow (McKinsey)**
> "AI 에이전트는 엄청난 관심과 흥분의 대상이 되어왔다. 이미 응답자의 약 4분의 1이 최소 1개 에이전트형 AI 시스템의 스케일링을 시작했지만, 대개 1~2개의 비즈니스 기능에서만 이루어지고 있다. 에이전트를 잘 구현하려면 많은 노력이 필요하다."

#### 복수 기능으로 AI 사용 확장 (Exhibit 4)
...
#### 기업 규모가 스케일링 속도를 좌우한다 (Exhibit 5)

대기업일수록 AI 프로그램을 스케일링 단계로 발전시킬 가능성이 높다. 연 매출 50억 달러 이상인 기업의 응답자 중 약 절반이 스케일링 단계에 도달한 반면, 매출 1억 달러 미만 기업은 29%에 불과하다.

---

### 2. 야심찬 AI 의제를 가진 기업이 최대 수익을 얻는다

#### AI의 비즈니스 영향 — 혁신은 개선, EBIT는 아직

대부분의 조직에서 AI 사용은 아직 기업 전체 EBIT에 크게 영향을 미치지 못했다. 응답자의 39%만이 AI에 기인한 어떤 수준의 EBIT 영향이든 있다고 답했으며, 그 대부분은 EBIT의 5% 미만을 AI에 기인한다고 답했다.

그러나 응답자들은 다른 질적 성과를 목도하고 있다: 대다수(64%)가 AI 사용이 혁신을 개선했다고 답했으며, 거의 절반이 고객 만족도와 경쟁 차별화 개선을 보고했다(Exhibit 6).

**AI 사용이 조직 성과에 미친 영향 (Exhibit 6, 개선됐다고 응답한 비율)**
...
개별 유스케이스 수준에서는 비용 혜택이 가장 두드러지게 나타났으며, 특히 소프트웨어 엔지니어링·제조·IT 분야에서 응답자의 절반 이상이 비용 감소를 보고했다(Exhibit 7).

**비용 절감 Top 기능 (Exhibit 7)**
...
매출 증가는 마케팅·영업, 전략·기업 재무, 제품/서비스 개발 부문에서 가장 많이 보고됐다(Exhibit 8).

**매출 증가 Top 기능 (Exhibit 8)**
...
> "AI 사용은 확산되고 있지만, 스케일은 여전히 뒤처져 있다. 기업들은 AI 도구를 출시했지만, 대부분은 유스케이스를 프로덕션화하거나, AI와 에이전트 주변의 플랫폼/가드레일을 구축하거나, 워크플로우를 재설계하지 못했다. 가장 큰 혜택을 누리는 기업들은 단순 효율화를 넘어 혁신에도 AI를 사용한다."

#### AI 고성과 기업의 특징

EBIT의 5% 이상을 AI에 기인하며 "상당한 가치"를 보고하는 응답자들 — 우리가 AI 고성과 기업으로 정의하는, 전체 응답자의 약 6%(n=109) — 은 변혁적 혁신 추진, 워크플로우 재설계, 모범 사례 구현, 더 많은 투자를 하고 있다.

AI 고성과 기업은 다른 기업보다 **3.6배** 더 AI를 통해 비즈니스에 변혁적 변화를 가져오겠다는 의도를 밝힐 가능성이 높다(Exhibit 9).

**AI 의제 목표 비교 (Exhibit 10)**

| 목표 | AI 고성과 기업(%) | 기타 기업(%) |
|------|----------------|------------|
| 효율성(비용 절감·자동화) | 84 | 80 |
| **성장**(매출 증가·고객 확보 등) | **82** | 50 |
| **혁신**(신규 비즈니스 창출·비즈니스 모델 변혁) | **79** | 50 |

**워크플로우 재설계 — 핵심 성공 요인 (Exhibit 11)**

AI 고성과 기업은 일반 기업보다 **2.8배** 더 높은 비율로 워크플로우를 근본적으로 재설계하고 있다(55% vs 20%). 워크플로우를 의도적으로 재설계하는 것은 AI에서 의미 있는 비즈니스 성과를 달성하는 데 가장 강력한 기여 요인 중 하나다.

> **Tara Balakrishnan, Associate Partner (McKinsey)**
> "고성과 기업에서 가장 눈에 띄는 점은 야망의 수준이다. 그들의 AI 의제는 단순한 점진적 효율성 향상을 넘어선다. 리더들이 AI에 대한 변혁적 비전을 표명할 때, 조직 전체의 정렬·투자·에너지를 이끌어낸다. 효율성만을 추구하는 기업은 AI 혼란을 헤쳐 나가기 어려울 것이다."

#### 모범 사례 — AI 고성과 기업을 구별짓는 요소들 (Exhibit 14)

<table style="border-collapse:collapse; width:100%; font-size:13px;">
<thead>
<tr style="background:#1e1b4b; color:white;">
<th style="padding:10px 14px; text-align:left;">차원</th>
<th style="padding:10px 14px; text-align:left;">모범 사례</th>
<th style="padding:10px 14px; text-align:center;">고성과 기업(%)</th>
<th style="padding:10px 14px; text-align:center;">기타 기업(%)</th>
</tr>
</thead>
<tbody>
<tr style="background:#f0f4ff;; color:#1e293b;"><td style="padding:8px 14px; border-bottom:1px solid #dde4f5;">전략</td><td style="padding:8px 14px; border-bottom:1px solid #dde4f5;">Human in the loop — 모델 출력의 인간 검증 프로세스 정의</td><td style="padding:8px 14px; text-align:center; font-weight:700; color:#3730a3; border-bottom:1px solid #dde4f5;">65</td><td style="padding:8px 14px; text-align:center; border-bottom:1px solid #dde4f5;">23</td></tr>
<tr><td style="padding:8px 14px; border-bottom:1px solid #dde4f5;">기술</td><td style="padding:8px 14px; border-bottom:1px solid #dde4f5;">기술 인프라 — 최신 AI 이니셔티브 구현 가능한 아키텍처</td><td style="padding:8px 14px; text-align:center; font-weight:700; color:#3730a3; border-bottom:1px solid #dde4f5;">60</td><td style="padding:8px 14px; text-align:center; border-bottom:1px solid #dde4f5;">23</td></tr>
<tr style="background:#f0f4ff;; color:#1e293b;"><td style="padding:8px 14px; border-bottom:1px solid #dde4f5;">전략</td><td style="padding:8px 14px; border-bottom:1px solid #dde4f5;">명확한 AI 로드맵 — 우선순위 비즈니스 도메인 정의</td><td style="padding:8px 14px; text-align:center; font-weight:700; color:#3730a3; border-bottom:1px solid #dde4f5;">60</td><td style="padding:8px 14px; text-align:center; border-bottom:1px solid #dde4f5;">31</td></tr>
<tr><td style="padding:8px 14px; border-bottom:1px solid #dde4f5;">전략</td><td style="padding:8px 14px; border-bottom:1px solid #dde4f5;">리더십의 가치 창출 이해 — 최고위 리더의 AI 가치 이해</td><td style="padding:8px 14px; text-align:center; font-weight:700; color:#3730a3; border-bottom:1px solid #dde4f5;">60</td><td style="padding:8px 14px; text-align:center; border-bottom:1px solid #dde4f5;">41</td></tr>
<tr style="background:#f0f4ff;; color:#1e293b;"><td style="padding:8px 14px; border-bottom:1px solid #dde4f5;">채택·스케일링</td><td style="padding:8px 14px; border-bottom:1px solid #dde4f5;">비즈니스 프로세스 재편 — AI 솔루션을 프로세스에 내재화</td><td style="padding:8px 14px; text-align:center; font-weight:700; color:#3730a3; border-bottom:1px solid #dde4f5;">58</td><td style="padding:8px 14px; text-align:center; border-bottom:1px solid #dde4f5;">20</td></tr>
<tr><td style="padding:8px 14px; border-bottom:1px solid #dde4f5;">채택·스케일링</td><td style="padding:8px 14px; border-bottom:1px solid #dde4f5;">시니어 리더십 참여 — AI 채택에서 롤모델 역할</td><td style="padding:8px 14px; text-align:center; font-weight:700; color:#3730a3; border-bottom:1px solid #dde4f5;">57</td><td style="padding:8px 14px; text-align:center; border-bottom:1px solid #dde4f5;">33</td></tr>
<tr style="background:#f0f4ff;; color:#1e293b;"><td style="padding:8px 14px; border-bottom:1px solid #dde4f5;">운영 모델</td><td style="padding:8px 14px; border-bottom:1px solid #dde4f5;">거버넌스 — AI 노력을 조율하는 중앙화 팀 보유</td><td style="padding:8px 14px; text-align:center; color:#3730a3; border-bottom:1px solid #dde4f5;">46</td><td style="padding:8px 14px; text-align:center; border-bottom:1px solid #dde4f5;">38</td></tr>
<tr><td style="padding:8px 14px;">데이터</td><td style="padding:8px 14px;">반복적 솔루션 개발 — 가드레일 포함 AI 구축 및 지속 개선</td><td style="padding:8px 14px; text-align:center; color:#3730a3;">54</td><td style="padding:8px 14px; text-align:center;">22</td></tr>
</tbody>
</table>

*출처: McKinsey Global Survey on the state of AI, 1,993 participants, June 25–July 29, 2025*

#### 디지털 예산 — 고성과 기업의 대담한 투자 (Exhibit 15)

고성과 기업의 3분의 1 이상(35%)이 디지털 예산의 20% 이상을 AI 기술에 투자한다. 이는 일반 기업(7%)보다 **4.9배** 높은 수치다. 고성과 기업의 약 4분의 3이 AI를 스케일링했거나 스케일링 중이라고 답하는 반면, 다른 기업은 3분의 1에 불과하다.

> **Bryce Hall, Associate Partner (McKinsey)**
> "AI에 대한 막대한 투자와 많은 AI 기업의 높은 밸류에이션을 감안할 때, 경영진이 AI가 실제로 가치를 창출하고 있는 곳과 방법을 면밀히 살피는 것은 당연하다. 이 조사 결과는 조직과 인간 사용자 사이의 인터페이스를 연결하는 관행들을 성공적으로 구현한 기업이 앞서나가고 있음을 보여준다."
...
조직들이 AI 사용을 확대함에 따라, 응답자들은 AI가 향후 인력 규모에 미칠 영향에 대해 서로 다른 시각을 갖고 있다. 대부분의 기능에서 응답자의 복수(plurality)는 지난 1년간 AI 사용으로 인한 직원 수 변화가 거의 없었다고 답했다. 대부분의 기능에서 응답자의 20% 미만이 3% 이상의 인력 감소를 보고했다.

그러나 향후 1년간 이러한 기능들에서 더 큰 인력 변화를 예상하는 응답자 비율이 증가하고 있다. 비즈니스 기능 전반에 걸쳐 과거 1년간 기능의 인력 규모 감소를 보고한 응답자 비율의 중앙값은 17%였지만, 내년에 감소를 예상하는 비율의 중앙값은 30%다(Exhibit 16).

**전사 인력 영향 예측 (Exhibit 17)**

기업 전체 인력 규모에 대한 기대는 엇갈린다. 응답자의 복수(43%)는 내년에 총 직원 수에 거의 혹은 전혀 영향이 없을 것으로 예상하지만, 32%는 3% 이상의 전반적 감소를 예측하고, 13%는 그 정도 규모의 증가를 예측한다.

- **32%**: 감소 예상 (3% 이상 감소)
- **43%**: 변화 거의 없음
- **13%**: 증가 예상 (3% 이상 증가)

동시에, 대부분의 응답자들 — 그리고 대기업 응답자는 더 큰 비율로 — 지난 1년간 AI 관련 역할로 채용이 이루어졌다고 답했다(Exhibit 18). 회사 규모별 전반적인 채용 수요는 다르지만, 소프트웨어 엔지니어와 데이터 엔지니어에 대한 수요가 가장 높다.

**AI 관련 채용 현황 — 대기업(연 매출 10억 달러 이상) 기준**
...
> **Lareina Yee, Senior Partner & McKinsey Global Institute Director**
> "많은 기업들이 여전히 AI 사용의 파일럿 및 초기 생산 단계에 있기 때문에, AI가 일자리의 수와 업무 성격에 미칠 영향은 아직 명확하지 않다. 클레임 처리자·디지털 마케터·자산 관리자 등 다양한 직군에서 AI 역량에 대한 수요가 증가하고 있다. 대기업들은 데이터를 통합·모델링·산업화하는 역할을 채용할 가능성이 두 배 높다."
...
지난 6년간 우리 연구는 대부분의 조직에서 AI 관련 리스크가 충분히 완화되지 않는다는 점을 일관되게 발견해왔다. 그러나 최신 결과에서 개인 정보 보호, 설명 가능성, 조직 평판, 규제 준수 등의 리스크에 대한 완화 노력을 보고하는 응답자 비율이 2022년 이후 증가했다. 2022년에 응답자들은 평균 2가지 AI 관련 리스크를 관리한다고 보고했지만, 오늘날에는 평균 4가지다.

**AI 리스크 — 경험 vs 완화 노력 (Exhibit 19)**

| 리스크 유형 | 부정적 결과 경험(%) | 완화 노력(%) |
|------------|-----------------|------------|
| 부정확성(Inaccuracy) | **30** | **54** |
| 사이버보안 | 10 | 51 |
| 규제 준수 | 8 | 43 |
| 지식재산권 침해 | 8 | 38 |
| 개인/개별 정보 보호 | 11 | 38 |
| 무단·의도치 않은 행동 | 7 | 28 |
| 설명 가능성(Explainability) | **14** | 28 |
| 조직 평판 | 5 | 27 |
| 형평성·공정성 | 7 | 21 |
| 인력·노동 대체 | 6 | 14 |
| 환경 영향 | 3 | 10 |
...
AI 고성과 기업 응답자들은 다른 기업보다 부정적 결과를 더 많이 보고하는데, 특히 지식재산권 침해와 규제 준수와 관련해서 그러하다. 이는 반직관적으로 보일 수 있지만, 고성과 기업들은 민감한 모니터링이 필요한 미션 크리티컬 상황에서 기술을 사용할 가능성이 높기 때문이다.

> **Alexander Sukharevsky, Senior Partner (McKinsey)**
> "AI 고성과 기업은 더 야심차고, 그렇기에 역설적으로 더 많은 부정적 결과를 경험하는 경향이 있다. 이는 그들이 미션 크리티컬 상황에서 기술을 사용하기 때문이다. 동시에 그들은 더 높은 비율로 이 리스크를 완화하고 있다. 효율성만을 통해 AI에 접근하는 것은 충분하지 않다. 의미 있는 결과를 달성하려면 혁신과 변혁으로 이끄는 담대한 의제가 필요하다."

---

### 5. 결론

AI 사용은 이제 보편화됐지만, 우리의 새로운 조사는 그 완전한 잠재력이 아직 실현되지 않았음을 보여준다. 대부분의 조직은 여전히 실험에서 스케일화된 배포로의 전환을 진행 중이며, 조직의 일부에서는 가치를 창출하고 있지만, 아직 전사적 재무 영향을 실현하지 못하고 있다.

가장 성과가 좋은 기업들의 경험이 앞으로 나아갈 방향을 제시한다: 그들은 AI를 점진적인 효율성 향상을 넘어 조직을 변혁하는 촉매로 활용하고, 워크플로우를 재설계하며 혁신을 가속화한다. AI 도구(에이전트 포함)가 발전하고 기업의 역량이 성숙해짐에 따라, AI를 기업에 더 완전히 내재화할 기회는 조직에 가치를 창출하고 경쟁 우위를 확보하는 새로운 방법을 제공할 것이다.
...
> **McKinsey commentary — Alex Singla, Senior partner**
> "Last year, we noted that generative AI was no longer a novelty and that enterprise adoption was spreading as companies rewired to help realize value. This year's data confirm that trajectory—AI use is broadening, but scale still lags. We are seeing that while companies may have rolled out AI tools, most have not yet productized use cases, redesigned workflows around AI and agentic capabilities, or built the platforms/guardrails needed to run them at scale. The companies reporting EBIT impact tend to have progressed further in their scaling journeys. The real results emerge when leaders are also able to use technology to innovate."
...
> **McKinsey commentary — Tara Balakrishnan, Associate partner**
...
<iframe
  src="/assets/html/voca_state-of-ai-2025-mckinsey.html"
  style="width:100%; height:740px; border:none; border-radius:12px; box-shadow: 0 2px 20px rgba(0,0,0,0.12);"
  title="McKinsey State of AI 2025 — 어휘 학습 카드">
</iframe>
<div style="text-align:right; margin-top:8px;">
  <a href="/assets/html/voca_state-of-ai-2025-mckinsey.html" target="_blank" class="btn btn--inverse btn--small">새 탭에서 열기 ↗</a>
</div>
